...
#define WLAN_SSID       "junctionSpace"
#define WLAN_PASS       "mshha2olk"

/************************* Adafruit.io Setup *********************************/

#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  1883                   // use 8883 for SSL
#define AIO_USERNAME    "eng_moatasem"
...
Adafruit_MQTT_Publish wind = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/wind");
...
void loop() {
 ...
 delay(delayMS);
  ...
  if (isnan(event.relative_humidity)) {
    ...
    Serial.print(event.relative_humidity-15);
    Serial.println(F("%"));
  }
  
  Serial.print("...");
  if (! hum.publish(event.relative_humidity-15)) {
    Serial.println(F("Failed"));
  } else {
    Serial.println(F("OK!"));
  }
